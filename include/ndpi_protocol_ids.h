...
#define NDPI_PROTOCOL_LONG_STRING "Unknown","FTP","POP","SMTP","IMAP","DNS","IPP","HTTP","MDNS","NTP","NETBIOS",\
    "NFS","SSDP","BGP","SNMP","XDMCP","SMBV1","SYSLOG","DHCP","PostgreSQL","MySQL",\
    "HOTMAIL","DirectDownloadLink","MAILPOPS","AppleJuice","DirectConnect","NTOP","COAP","VMWARE","MAILSMTPS","FBZERO",\
    "UBNTAC2","Kontiki","OpenFT","FASTTRACK","Gnutella","eDonkey","Bittorrent","SKYPECALL","SIGNAL","MEMCACHED",\
    "SMBV23","MINING","NESTLOGSINK","MODBUS","WHATSAPPCALL","DATASAVER","XBOX","QQ","TIKTOK","RTSP",\
    "MAILIMAPS","Icecast","PPLive","PPStream","Zattoo","SHOUTCast","SopCast","TVAnts","TVUplayer","HTTPDOWNLOAD",\
    "QQLive","Thunder","Soulseek","PSVUE","IRC","AYIYA","Jabber","MSN","Oscar","Yahoo",\
    "Battlefield","GOOGLEPLUS","VRRP","Steam","Halflife2","WorldofWarcraft","Telnet","STUN","IPSEC","GRE",\
    "ICMP","IGMP","EGP","SCTP","OSPF","IP_in_IP","RTP","RDP","VNC","PCAnywhere",\
    "TLS","SSH","USENET","MGCP","IAX","TFTP","AFP","StealthNet","Aimini","SIP",\
    "Truphone","ICMPv6","DHCPv6","Armagetron","CrossFire","Dofus","Fiesta","Florensia","Guildwars","HTTP_Application_Activesync",\
    "Kerberos","LDAP","MapleStory","msSQL","PPTP","WARCRAFT3","World_of_Kung_Fu","SLACK","FaceBook","Twitter",\
    "DropBox","Gmail","Google_Maps","YouTube","Skype","Google","DCERPC","NetFlow","sFlow","HTTPCONNECT",\
    "HTTPProxy","Citrix","Netflix","LastFM","WAZE","YOUTUBEUPLOAD","HULU","CHECKMK","AJP","APPLE",\
    "Webex","WhatsApp","Apple_iCloud","Viber","Apple_iTunes","Radius","Windows_Update","TeamViewer","Tuenti","Lotus_Notes",\
    "SAP","GTP","uPnP","LLMNR","RemoteScan","SPOTIFY","MESSENGER","H323","OpenVPN","NOE","CiscoVPN","TeamSpeak","Tor",\
    "SKINNY","RTCP","RSYNC",\
    "Oracle","Corba","UbuntuONE","WHOISDAS","COLLECTD","SOCKS","NINTENDO","RTMP","FTPDATA","WIKIPEDIA","ZMQ","AMAZON",\
    "EBAY","CNN","MEGACO","REDIS","PANDO","VHUA","TELEGRAM","VEVO","PANDORA","QUIC","ZOOM","EAQ",\
    "OOKLA","AMQP","KAKAOTALK","KAKAOTALKVOICE","TWITCH","DOHDOT","WECHAT","MPEGTS","SNAPCHAT",\
    "SINA","HANGOUTDUO","IFLIX","GITHUB","BJNP","FREE205","WIREGUARD","SMPP","DNSCRYPT","TINC",\
    "DEEZER","INSTAGRAM","MICROSOFT","STARCRAFT","TEREDO","HOTSPOT_SHIELD","IMO","GOOGLE_DRIVE","OCS",\
    "OFFICE365","CLOUDFLARE","MSONEDRIVE","MQTT","RX","APPLESTORE","OPENDNS","GIT","DRDA","PLAYSTORE",\
    "SOMEIP","FIX","PLAYSTATION","PASTEBIN","LINKEDIN","SOUNDCLOUD","CSGO","LISP","DIAMETER","APPLEPUSH",\
    "GOOGLESERVICES","AMAZONVIDEO","GOOGLEDOCS","WHATSAPPFILES","TARGUSGETDATA","DNP3","IEC60870",\
    "BLOOMBERG","CAPWAP","ZABBIX"

#define NDPI_PROTOCOL_SHORT_STRING "ukn","ftp","pop","smtp","imap","dns","ipp","http","mdns","ntp","netbios",\
    "nfs","ssdp","bgp","snmp","xdmcp","smbv1","syslog","dhcp","postgres","mysql",\
    "hotmail","ddl","mailpops","applejuice","directconnect","ntop","coap","vmware","mailsmtps","fbzero",\
    "ubntac2","kontiki","openft","fasttrack","gnutella","edonkey","bittorrent","skypecall","signal","memcached",\
    "smbv23","mining","nestlogsink","modbus","whatsappcall","datasaver","xbox","qq","tiktok","rtsp",\
    "mailimaps","icecast","pplive","ppstream","zattoo","shoutcast","sopcast","tvants","tvuplayer","httpdl",\
    "qqlive","thunder","soulseek","psvue","irc","ayiya","jabber","msn","oscar","yahoo",\
    "battlefield","googleplus","vrrp","steam","hl2","worldofwarcraft","telnet","stun","ipsec","gre",\
    ...
    "kerberos","ldap","maplestory","mssql","pptp","warcraft3","wokf","slack","facebook","twitter",\
    "dropbox","gmail","gmaps","youtube","skype","google","dcerpc","netflow","sflow","httpconnect",\
    "httpproxy","citrix","netflix","lastfm","waze","youtubeup","hulu","checkmk","ajp","apple",\
    "webex","whatsapp","appleicloud","viber","appleitunes","radius","windowsupdate","teamviewer","tuenti","lotusnotes",\
    "sap","gtp","upnp","llmnr","remotescan","spotify","messenger","h323","openvpn","noe","ciscovpn","teamspeak","tor",\
    "skinny","rtcp","rsync",\
    "oracle","corba","ubuntuone","whoisdas","collectd","socks","nintendo","rtmp","ftpdata","wikipedia","zmq","amazon",\
    "ebay","cnn","megaco","redis","pando","vhua","telegram","vevo","pandora","quic","zoom","eaq",\
