...
int ndpi_init_serializer_ll(ndpi_serializer *_serializer,ndpi_serialization_format fmt,u_int32_t buffer_size)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
...
#ifdef __KERNEL__
    serializer->buffer = (u_int8_t *) kmalloc(serializer->buffer_size * sizeof(u_int8_t),GFP_KERNEL);
#else
...
int ndpi_init_serializer(ndpi_serializer *_serializer, ndpi_serialization_format fmt)
{
...
#ifdef __KERNEL__
    r = krealloc((void *) serializer->buffer, new_size, GFP_KERNEL);
#else
...
static inline void ndpi_serialize_single_uint8(ndpi_private_serializer *serializer,u_int8_t s)
{
    u_int8_t v = s;
...
static inline void ndpi_serialize_single_uint16(ndpi_private_serializer *serializer,u_int16_t s)
{
    u_int16_t v = htons(s);
...
static inline void ndpi_serialize_single_uint32(ndpi_private_serializer *serializer,u_int32_t s)
{
    u_int32_t v = htonl(s);
...
static inline void ndpi_serialize_single_uint64(ndpi_private_serializer *serializer,u_int64_t s) 
{
...
static inline void ndpi_deserialize_single_uint8(ndpi_private_deserializer *deserializer,u_int32_t offset, u_int8_t *s) 
{
...
static inline void ndpi_deserialize_single_uint16(ndpi_private_deserializer *deserializer,u_int32_t offset, u_int16_t *s)
{
...
static inline void ndpi_deserialize_single_uint32(ndpi_private_deserializer *deserializer,u_int32_t offset, u_int32_t *s)
{
...
static inline void ndpi_deserialize_single_int8(ndpi_private_deserializer *deserializer,u_int32_t offset, int8_t *s)
{
...
static inline void ndpi_deserialize_single_int16(ndpi_private_deserializer *deserializer,u_int32_t offset, int16_t *s) 
{
...
static inline void ndpi_deserialize_single_int32(ndpi_private_deserializer *deserializer,u_int32_t offset, int32_t *s) 
{
...
static inline void ndpi_deserialize_single_uint64(ndpi_private_deserializer *deserializer,u_int32_t offset, u_int64_t *s) 
{
...
static inline void ndpi_deserialize_single_int64(ndpi_private_deserializer *deserializer,u_int32_t offset, int64_t *s) 
{
...
int ndpi_serialize_uint32_uint32(ndpi_serializer *_serializer,u_int32_t key, u_int32_t value) 
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
    u_int16_t needed = sizeof(u_int8_t) /* type */ + sizeof(u_int32_t) /* key */ + sizeof(u_int32_t);
...
int ndpi_serialize_uint32_uint64(ndpi_serializer *_serializer,u_int32_t key, u_int64_t value)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
    u_int16_t needed = sizeof(u_int8_t) /* type */ + sizeof(u_int32_t) /* key */ + sizeof(u_int64_t);
...
int ndpi_serialize_uint32_int32(ndpi_serializer *_serializer,u_int32_t key, int32_t value)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
    u_int16_t needed = sizeof(u_int8_t) /* type */ +sizeof(u_int32_t) /* key */ +sizeof(int32_t);
...
int ndpi_serialize_uint32_int64(ndpi_serializer *_serializer, u_int32_t key, int64_t value)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
    u_int16_t needed = sizeof(u_int8_t) /* type */ + sizeof(u_int32_t) /* key */ + sizeof(int64_t);
...
int ndpi_serialize_uint32_float(ndpi_serializer *_serializer,u_int32_t key, float value,const char *format /* e.f. "%.2f" */)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
    u_int16_t needed = sizeof(u_int8_t) /* type */ + sizeof(u_int32_t) /* key */ + sizeof(float);
...
static int ndpi_serialize_uint32_binary(ndpi_serializer *_serializer, u_int32_t key, const char *value, u_int16_t slen)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
    u_int32_t needed = sizeof(u_int8_t) /* type */ + sizeof(u_int32_t) /* key */ + sizeof(u_int16_t) /* len */ + slen;
...
int ndpi_serialize_uint32_string(ndpi_serializer *_serializer, u_int32_t key, const char *_value)
{
...
int ndpi_serialize_uint32_boolean(ndpi_serializer *_serializer, u_int32_t key, u_int8_t value)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
    u_int32_t needed = 24;
...
static int ndpi_serialize_binary_int32(ndpi_serializer *_serializer,const char *key, u_int16_t klen, int32_t value)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
    u_int32_t needed;
    ...
    if(ndpi_is_number(key, klen)) {
        int value_key;
#ifdef __KERNEL__
        kstrtouint(key, 10, &value_key);
#else
        value_key = atoi(key);
#endif
        return(ndpi_serialize_uint32_int32(_serializer, value_key, value));
    }
...
int ndpi_serialize_binary_int64(ndpi_serializer *_serializer, const char *key, u_int16_t klen, int64_t value)
{
    ...
    if(ndpi_is_number(key, klen)) {
        ...
        value_key = atoi(key);
#endif
        return(ndpi_serialize_uint32_int64(_serializer, value_key, value));
    }
...
int ndpi_serialize_string_int64(ndpi_serializer *_serializer, const char *key, int64_t value)
{
...
static int ndpi_serialize_binary_uint32(ndpi_serializer *_serializer, const char *key, u_int16_t klen, u_int32_t value)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
    u_int32_t needed;
    ...
    if(ndpi_is_number(key, klen)) {
        ...
        value_key = atoi(key);
#endif
        return(ndpi_serialize_uint32_uint32(_serializer, value_key, value));
    }
...
int ndpi_serialize_string_uint32(ndpi_serializer *_serializer, const char *key, u_int32_t value)
{
...
int ndpi_serialize_string_uint32_format(ndpi_serializer *_serializer,const char *key, u_int32_t value,const char *format)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
...
static int ndpi_serialize_binary_uint64(ndpi_serializer *_serializer,const char *key, u_int16_t klen,u_int64_t value)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
    u_int32_t needed;
    ...
    if(ndpi_is_number(key, klen)) {
        ...
        value_key = atoi(key);
#endif
        return(ndpi_serialize_uint32_uint64(_serializer, value_key, value));
    }
...
int ndpi_serialize_string_uint64(ndpi_serializer *_serializer, const char *key, u_int64_t value)
{
                                       ...
                                       const char *format /* e.f. "%.2f" */)
{
    ...
    if(ndpi_is_number(key, klen)) {
        ...
        value_key = atoi(key);
#endif
        return(ndpi_serialize_uint32_float(_serializer, value_key, value, format));
    }
...
static int ndpi_serialize_binary_raw(ndpi_serializer *_serializer,const char *key,u_int16_t klen,const char *value,u_int16_t vlen,u_int8_t escape) 
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
    u_int32_t needed;

    needed = sizeof(u_int8_t) /* type */ + sizeof(u_int16_t) /* key len */ + klen +
            sizeof(u_int16_t) /* len */ + vlen;
...
static int ndpi_serialize_binary_binary(ndpi_serializer *_serializer,const char *key,u_int16_t klen,const char *_value,u_int16_t vlen) 
{
    const char *value = _value ? _value : "";
    ...
    if(ndpi_is_number(key, klen)) {
        ...
        value_key = atoi(key);
#endif
        return(ndpi_serialize_uint32_binary(_serializer, value_key, value, vlen));
    }
...
int ndpi_serialize_string_binary(ndpi_serializer *_serializer,const char *key, const char *_value,u_int16_t vlen)
{
...
int ndpi_serialize_string_string(ndpi_serializer *_serializer,const char *key, const char *_value)
{
    const char *value = _value ? _value : "";
...
int ndpi_serialize_string_boolean(ndpi_serializer *_serializer,const char *key, u_int8_t value)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
    ...
    if(ndpi_is_number(key, klen)) {
        ...
        value_key = atoi(key);
#endif
        return(ndpi_serialize_uint32_boolean(_serializer, value_key, value));
    }
...
int ndpi_serialize_start_of_block(ndpi_serializer *_serializer, const char *key)
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;
    u_int32_t buff_diff = serializer->buffer_size - serializer->status.size_used;
...
int ndpi_init_deserializer_buf(ndpi_deserializer *_deserializer,u_int8_t *serialized_buffer,u_int32_t serialized_buffer_len)
{
...
int ndpi_init_deserializer(ndpi_deserializer *deserializer,ndpi_serializer *_serializer) 
{
    ndpi_private_serializer *serializer = (ndpi_private_serializer*)_serializer;

    return(ndpi_init_deserializer_buf(deserializer,serializer->buffer,serializer->status.size_used));
}
...
int ndpi_deserialize_key_uint32(ndpi_deserializer *_deserializer,u_int32_t *key)
{
    ndpi_private_deserializer *deserializer = (ndpi_private_deserializer*)_deserializer;
...
int ndpi_deserialize_key_string(ndpi_deserializer *_deserializer,ndpi_string *key)
{
    ndpi_private_deserializer *deserializer = (ndpi_private_deserializer*)_deserializer;
    ndpi_serialization_type kt;
    u_int32_t buff_diff = deserializer->buffer_size - deserializer->status.size_used;
...
int ndpi_deserialize_value_uint32(ndpi_deserializer *_deserializer,u_int32_t *value)
{
    ndpi_private_deserializer *deserializer = (ndpi_private_deserializer*)_deserializer;
    ndpi_serialization_type kt, et;
    u_int32_t offset, buff_diff = deserializer->buffer_size - deserializer->status.size_used;
...
int ndpi_deserialize_value_uint64(ndpi_deserializer *_deserializer, u_int64_t *value)
{
    ndpi_private_deserializer *deserializer = (ndpi_private_deserializer*)_deserializer;
    ndpi_serialization_type kt, et;
    u_int32_t buff_diff = deserializer->buffer_size - deserializer->status.size_used;
...
int ndpi_deserialize_value_int32(ndpi_deserializer *_deserializer,int32_t *value)
{
    ndpi_private_deserializer *deserializer = (ndpi_private_deserializer*)_deserializer;
    ndpi_serialization_type kt, et;
    u_int32_t offset, buff_diff = deserializer->buffer_size - deserializer->status.size_used;
...
int ndpi_deserialize_value_int64(ndpi_deserializer *_deserializer,int64_t *value)
{
    ndpi_private_deserializer *deserializer = (ndpi_private_deserializer*)_deserializer;
    ndpi_serialization_type kt, et;
    u_int32_t buff_diff = deserializer->buffer_size - deserializer->status.size_used;
